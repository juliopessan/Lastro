...
8. **O cliente assina direto na página.** Sem PDF, sem e-mail de ida e volta: ele desenha a assinatura, o sistema grava nome, traço e data/hora — e o status da proposta muda pra "Aceita" sozinho. O PDF anexado também não é um beco sem saída: traz o endereço da proposta como link clicável (e legível, pra funcionar impresso) e um quadro de assinatura em punho pra quem preferir papel.
